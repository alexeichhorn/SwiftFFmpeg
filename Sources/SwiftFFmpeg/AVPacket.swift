...
public final class AVPacket {
    var native: UnsafeMutablePointer<FFmpeg.AVPacket>!
    
    init(native: UnsafeMutablePointer<FFmpeg.AVPacket>) {
        self.native = native
    }
...
public enum AVPacketSideDataType: UInt32 {
    ...
    var native: FFmpeg.AVPacketSideDataType {
        FFmpeg.AVPacketSideDataType(rawValue)
    }
    
    init(native: FFmpeg.AVPacketSideDataType) {
