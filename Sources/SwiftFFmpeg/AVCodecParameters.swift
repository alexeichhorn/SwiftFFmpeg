...
public final class AVCodecParameters {
    var native: UnsafeMutablePointer<FFmpeg.AVCodecParameters>!
    var owned = false
    
    init(native: UnsafeMutablePointer<FFmpeg.AVCodecParameters>) {
        self.native = native
    }
    ...
    public func copy(from codecpar: AVCodecParameters) throws {
        try throwIfFail(avcodec_parameters_copy(native, codecpar.native))
    }
    
    /// Fill the parameters struct based on the values from the supplied codec context.
//    public func copy(from codecCtx: AVCodecContext) throws {
//        try throwIfFail(avcodec_parameters_from_context(native, codecCtx.native))
//    }
}
