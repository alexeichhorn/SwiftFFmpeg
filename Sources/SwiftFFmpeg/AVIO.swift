...
public final class AVIOContext {
    var native: UnsafeMutablePointer<FFmpeg.AVIOContext>!
    var opaque: IOBox?
    var owned = false
    var isOpen = false
    
    init(native: UnsafeMutablePointer<FFmpeg.AVIOContext>) {
        self.native = native
    }
    ...
    public init(
        ...
        guard let ctxPtr = ptr else {
            fatalError("avio_alloc_context") // TODO: handle more gracefully
        }
        self.native = ctxPtr
        self.opaque = box
        self.owned = true
    ...
    public convenience init(
        ...
        var pb: UnsafeMutablePointer<FFmpeg.AVIOContext>!
...
//    }
    ...
    public func accept() throws -> AVIOContext {
        var ptr: UnsafeMutablePointer<FFmpeg.AVIOContext>!
